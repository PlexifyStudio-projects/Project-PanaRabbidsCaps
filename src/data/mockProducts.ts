...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    name: 'Exclusivas',
    slug: 'exclusivas',
    description: 'Ediciones limitadas solo en Pana Rabbids',
...
export const PRODUCTS: Product[] = [
  {
    ...
    isFeatured: true,
    skuPrefix: 'NYY-BLK',
    metaTitle: 'Gorra New York Yankees Negra | Pana Rabbids',
    metaDescription: 'Gorra oficial New York Yankees 59FIFTY negra. Envío gratis en Pana Rabbids.',
    images: [
  ...
  },
  {
    ...
    isFeatured: true,
    skuPrefix: 'LAD-BLU',
    metaTitle: 'Gorra LA Dodgers Azul | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: true,
    skuPrefix: 'URB-PH',
    metaTitle: 'Urban Phantom Snapback | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: true,
    skuPrefix: 'CHI-RED',
    metaTitle: 'Gorra Chicago Bulls Roja | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'RAI-SBK',
    metaTitle: 'Gorra Raiders Plata y Negro | Pana Rabbids',
  ...
  },
  {
    ...
    name: 'Pana Gold Edition Limited',
    slug: 'pana-gold-edition-limited',
    description: 'EDICIÓN LIMITADA. Solo 50 unidades en el mundo. La gorra insignia de Pana Rabbids con bordado dorado premium, tela importada y acabado de lujo. Certificado de autenticidad incluido. Esta no es solo una gorra, es una declaración.',
    basePrice: 350000,
    comparePrice: null,
    isActive: true,
    isFeatured: true,
    skuPrefix: 'PAN-GLD',
    metaTitle: 'Pana Gold Edition Limited | Pana Rabbids',
    metaDescription: 'Edición limitada Pana Rabbids Gold. Solo 50 unidades.',
    images: [
      { id: 13, productId: 6, imageUrl: IMG.cap6, altText: 'Pana Gold frontal', sortOrder: 1, isPrimary: true },
      { id: 14, productId: 6, imageUrl: IMG.cap12, altText: 'Pana Gold detalle', sortOrder: 2, isPrimary: false },
      { id: 15, productId: 6, imageUrl: IMG.model3, altText: 'Pana Gold modelo', sortOrder: 3, isPrimary: false },
    ],
    variants: [
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'BOS-GRN',
    metaTitle: 'Gorra Retro Boston Celtics | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'MID-STL',
    metaTitle: 'Midnight Stealth Trucker | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'BRS-NVY',
    metaTitle: 'Gorra Boston Red Sox Navy | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'LAL-PRP',
    metaTitle: 'Gorra Lakers Showtime Purple | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'DAL-NVY',
    metaTitle: 'Gorra Dallas Cowboys Navy | Pana Rabbids',
  ...
  },
  {
    ...
    categoryId: 6,
    category: CATEGORIES[5],
    name: 'Pana Rabbids OG Snapback',
    slug: 'pana-rabbids-og-snapback',
    description: 'El OG. La primera gorra de Pana Rabbids. Logo bordado en dorado sobre negro mate. Snapback premium con broche metálico. Si no tienes esta, no eres del club.',
    basePrice: 159000,
    comparePrice: null,
    isActive: true,
    isFeatured: true,
    skuPrefix: 'PAN-OG',
    metaTitle: 'Pana Rabbids OG Snapback | Pana Rabbids',
    metaDescription: 'La gorra original de Pana Rabbids. OG Snapback negra y dorada.',
    images: [
      { id: 22, productId: 12, imageUrl: IMG.cap10, altText: 'Pana OG frontal', sortOrder: 1, isPrimary: true },
      { id: 23, productId: 12, imageUrl: IMG.model4, altText: 'Pana OG modelo', sortOrder: 2, isPrimary: false },
    ],
    variants: [
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'NYM-WSH',
    metaTitle: 'Gorra Vintage NY Mets Washed | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'SHD-CHR',
    metaTitle: 'Shadow Chrome Dad Hat | Pana Rabbids',
  ...
  },
  {
    ...
    isFeatured: false,
    skuPrefix: 'KC-RED',
    metaTitle: 'Gorra Chiefs Kingdom Red | Pana Rabbids',
  ...
  },
  {
    ...
    categoryId: 6,
    category: CATEGORIES[5],
    name: 'Pana Rabbids Camo Limited',
    slug: 'pana-rabbids-camo-limited',
    description: 'EDICIÓN LIMITADA. 100 unidades. Camuflaje digital con detalles dorados. La fusión perfecta entre street y militar. Logo Pana Rabbids bordado en 3D. No la vas a encontrar en ningún otro lado.',
    basePrice: 275000,
    comparePrice: 320000,
    isActive: true,
    isFeatured: true,
    skuPrefix: 'PAN-CMO',
    metaTitle: 'Pana Rabbids Camo Limited | Pana Rabbids',
    metaDescription: 'Edición limitada camuflaje digital Pana Rabbids. Solo 100 unidades.',
    images: [
      { id: 27, productId: 16, imageUrl: IMG.cap14, altText: 'Pana Camo frontal', sortOrder: 1, isPrimary: true },
      { id: 28, productId: 16, imageUrl: IMG.cap13, altText: 'Pana Camo detalle', sortOrder: 2, isPrimary: false },
    ],
    variants: [
